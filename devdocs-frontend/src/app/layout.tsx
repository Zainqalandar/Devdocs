...
export const metadata: Metadata = {
  title: { default: "DevDocs — Programming Documentation", template: "%s | DevDocs" },
  description: "Structured documentation for every major programming language and framework.",
};
